...
function Group1() {
  return (
    <div className="absolute contents left-0 top-0">
      ...
      <p className="absolute bg-clip-text bg-gradient-to-r font-['Teko',sans-serif] font-medium from-[37.225%] from-black h-[25.212px] leading-[normal] left-[3.95px] text-[30px] to-[#c1c1c1] to-[50.551%] top-[4.58px] w-[160.126px]" style={{ WebkitTextFillColor: "transparent" }}>
        ADDING PROMOS
      </p>
    </div>
  );
